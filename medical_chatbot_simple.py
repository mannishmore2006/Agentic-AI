...
prompt = ChatPromptTemplate.from_messages([
    ("system", """You are a helpful medical assistant that provides accurate responses based on medical documents. 
Provide clear, structured answers with medical facts and information from the context.
